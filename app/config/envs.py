...
queue_name = os.getenv(key="RABBITMQ_QUEUE_RECIEVE", default="assets.img.template.1")
binding_key = os.getenv(key="RABBITMQ_BINDING_KEY", default="assets.img.template.1")
