...
# Gral
source = os.getenv(key="SOURCE", default="aa-microservice.img.template-python")
...
queue_name = os.getenv(key="RABBITMQ_QUEUE_RECIEVE", default="assets.img.template")
binding_key = os.getenv(key="RABBITMQ_BINDING_KEY", default="assets.img.template")
queue_name_send = os.getenv(key="RABBITMQ_QUEUE_SEND", default="assets.processed")
